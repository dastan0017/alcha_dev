...
export const COLLECTION_SCHEMAS: { readonly [C in CollectionKey]: CollectionSchema<C> } = {
  ...
  projects: {
    ...
    fields: [
      ...
      {
        key: 'badge',
        label: 'Бейдж — тип проекта',
        type: 'text',
        localized: true,
        hint: 'КЛИЕНТСКИЙ ПРОЕКТ',
      },
      {
        key: 'typeTag',
        label: 'Имя проекта мелким шрифтом (над заголовком)',
        type: 'text',
        localized: true,
        hint: 'Kit Store',
      },
    ...
    blank: ({ page }) => {
      ...
      return {
        ...
        ru: {
          ...node.ru,
          title: 'Что получил клиент — одной строкой',
          badge: 'КЛИЕНТСКИЙ ПРОЕКТ',
          typeTag: 'Название проекта',
        ...
        en: {
          ...node.en,
          title: 'What the client got, in one line',
          badge: 'CLIENT PROJECT',
          typeTag: 'Project name',
